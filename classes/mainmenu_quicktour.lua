...
function MainMenu_QuickTour:init()
	...
	if tonumber(tourTable["QuickTourStage"]) > 0 then
		...
		local stats = "Saved game Info:\n \n"..
					classTable[tourTable["QuickTourClass"]][11]..stagename.."\n"..
					"Next opponent: "..classTable[tourTable["QuickTourOpponent"]][11].."\n"..
					"Next Arena: "..arenasTable[tourTable["QuickTourArena"]]["Name"].."\n"..
