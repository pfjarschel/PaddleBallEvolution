...
function SlideColorPicker:init()
	...
	self.hue = Bitmap.new(Texture.new("include/colorPick/hue.png", true))
	self.hue:setPosition(0, 0)
	self.arrows = Texture.new("include/colorPick/arrows.png", true)
	self.hueArrows = Bitmap.new(self.arrows)
	self.hueArrows:setPosition(147, 0)
	self.brightnessBg = Sprite.new()
	self.brightness = Bitmap.new(Texture.new("include/colorPick/brightness.png", true))
